...
__C.model.semantic_fusion_fixed_nonempty_gate = False
...
__C.data.use_change_mask = False
__C.data.mask_type = 'binary'
__C.data.num_mask_classes = 1
__C.data.mask_label_dir = ''
__C.data.mask_label_rgb_dir = ''
__C.data.use_semantic_maps = False
__C.data.semantic_map_root = ''
...
__C.data.changeflag_json = ''
__C.data.return_dict = False
...
__C.train.mask_dice_include_background = False
...
__C.train.semantic_warmup_end = 7000
__C.train.semantic_warmup_type = 'linear'
__C.train.use_aux_warmup = False
__C.train.aux_warmup_start_ratio = 0.30
__C.train.aux_warmup_end_ratio = 0.70
__C.train.semantic_decay_start_ratio = 0.70
__C.train.semantic_decay_final_ratio = 0.50
__C.train.semantic_late_start = False
__C.train.semantic_start_iter = 5000
__C.train.semantic_loss_type = 'multilabel_bce'
__C.train.semantic_ignore_index = -1
__C.train.semantic_dice_include_background = False

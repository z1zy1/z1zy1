...
Generated: `2026-09-09T08:42:46.938336+00:00`  
Repository: `/root/autodl-tmp/z1zy1`  
Pair root: `/root/autodl-tmp/z1zy1/experiments/paired_card_rsaca_recovery_v1`  
...
| State | Count | Meaning |
|---|---:|---|
| VERIFIED_COMPLETE | 12 | selection and complete locked test are present |
...
| NEED_TEST_OR_RESCORING | 1 | selection exists but complete test record does not |
...
|---|---:|---|---|---|---|---|
| LEVIR-CC | 1111 | VERIFIED_COMPLETE | VERIFIED_COMPLETE | QUALIFIED_COMPLETE | yes | yes |
| LEVIR-CC | 2222 | VERIFIED_COMPLETE | VERIFIED_COMPLETE | QUALIFIED_COMPLETE | yes | yes |
| LEVIR-CC | 3333 | VERIFIED_COMPLETE | VERIFIED_COMPLETE | QUALIFIED_COMPLETE | yes | yes |
| LEVIR-MCI | 1111 | VERIFIED_COMPLETE | VERIFIED_COMPLETE | QUALIFIED_COMPLETE | yes | yes |
| LEVIR-MCI | 2222 | VERIFIED_COMPLETE | VERIFIED_COMPLETE | QUALIFIED_COMPLETE | yes | yes |
| LEVIR-MCI | 3333 | VERIFIED_COMPLETE | VERIFIED_COMPLETE | QUALIFIED_COMPLETE | yes | yes |
| SECOND-CC-AUG | 1111 | NEED_TEST_OR_RESCORING | RESUME_OR_RETRAIN | BLOCKED_BY_RESUME_OR_RETRAIN | no | no |
...
|---|---|---:|---|---:|---|---|---|---|---|
| LEVIR-CC | card | 1111 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-CC | card | 2222 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-CC | card | 3333 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-CC | rsaca | 1111 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-CC | rsaca | 2222 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-CC | rsaca | 3333 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-MCI | card | 1111 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-MCI | card | 2222 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-MCI | card | 3333 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-MCI | rsaca | 1111 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-MCI | rsaca | 2222 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| LEVIR-MCI | rsaca | 3333 | VERIFIED_COMPLETE | 10000 | yes | yes | yes | yes | yes |
| SECOND-CC-AUG | card | 1111 | NEED_TEST_OR_RESCORING | 10000 | yes | yes | no | yes | no |
...
| SECOND-CC-AUG | rsaca | 1111 | RESUME_OR_RETRAIN | - | no | yes | no | no | no |
...
```bash
cd /root/autodl-tmp/z1zy1 && PAIR_ROOT=/root/autodl-tmp/z1zy1/experiments/paired_card_rsaca_recovery_v1 NUM_WORKERS=8 OMP_NUM_THREADS=1 PYTHON=/root/miniconda3/envs/card/bin/python bash scripts/run_paired_card_rsaca_matrix.sh --stage test --dataset second_cc --seed 1111 --dry-run
```
### SECOND-CC-AUG / rsaca / seed 1111
```bash
cd /root/autodl-tmp/z1zy1 && PAIR_ROOT=/root/autodl-tmp/z1zy1/experiments/paired_card_rsaca_recovery_v1 NUM_WORKERS=8 OMP_NUM_THREADS=1 PYTHON=/root/miniconda3/envs/card/bin/python bash scripts/run_paired_card_rsaca_matrix.sh --stage train --dataset second_cc --seed 1111 --dry-run  # dry-run only; existing failed directory must be archived/new protocol confirmed
```

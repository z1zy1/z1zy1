...
- Current run: tmux `p1_rsaca_train_r1`, `card_levir_cc_seed1111` observed through step 1400; after all runs complete, run validation selection, then immutable test.

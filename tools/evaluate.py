"""Unified validation launcher backed by the legacy evaluation path."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description='Run validation inference for one checkpoint.')

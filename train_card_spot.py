...
parser.add_argument('--semantic_map_root', type=str, default=None)
parser.add_argument('--semantic_before_phase', type=str, default=None)
parser.add_argument('--semantic_after_phase', type=str, default=None)
parser.add_argument('--semantic_diff_root', type=str, default=None)
parser.add_argument('--semantic_diff_phase', type=str, default=None)
parser.add_argument('--semantic_diff_only', action='store_true')
parser.add_argument('--semantic_diff_binary', action='store_true')
